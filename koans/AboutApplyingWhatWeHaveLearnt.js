...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      var productsICanEat = _(products).filter(function(pizza) {
          return _(pizza.ingredients).all(function(ingredient){return ingredient !== "mushrooms"}) && pizza.containsNuts === false;
      });
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    ...
    var numArray = _.range(1,1000);
    var sum = _(numArray).chain()       
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var ingredientCount = _(products).chain()  
                          ...
                          .reduce(function(acum,b) {
                          acum[b] = (acum[b] || 0) + 1;
                          return acum; 
                          }, {})
                          .value();
                          // _.filter(function(ingredient) {ingredient === "mushrooms"})
